...
Check(RestGuidance.Get("Eyes", 35).Title.Contains("’£"), "eye sequence advances to gentle blinking");
...
Check(RestGuidance.Get("Calm", 20).Instruction.Contains("≤ª”√∆¡œ¢"), "calm does not require breath holding");
Console.WriteLine($"Total: {checks} checks passed");
